...
typedef enum {
    ...
    HSC_CAP_LIGHTS                         = 3,
    HSC_CAP_LIGHT_COLOR                    = 4,
    HSC_CAP_LIGHT_BRIGHTNESS               = 5,
    HSC_CAP_LIGHT_MODE                     = 6,
    HSC_CAP_LIGHT_SPEED                    = 7,
    HSC_CAP_INACTIVE_TIME                  = 8,
    HSC_CAP_CHATMIX_STATUS                 = 9,
    HSC_CAP_VOICE_PROMPTS                  = 10,
    HSC_CAP_ROTATE_TO_MUTE                 = 11,
    HSC_CAP_EQUALIZER_PRESET               = 12,
    HSC_CAP_EQUALIZER                      = 13,
    HSC_CAP_PARAMETRIC_EQUALIZER           = 14,
    HSC_CAP_MICROPHONE_MUTE_LED_BRIGHTNESS = 15,
    HSC_CAP_MICROPHONE_VOLUME              = 16,
    HSC_CAP_VOLUME_LIMITER                 = 17,
    HSC_CAP_BT_WHEN_POWERED_ON             = 18,
    HSC_CAP_BT_CALL_VOLUME                 = 19,
